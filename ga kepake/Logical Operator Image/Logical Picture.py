...
img1 = cv2.imread('Dataset/Gambar Geometri/trapezoid_1.png', cv2.IMREAD_GRAYSCALE)
img1 = (img1 == 255).astype(int) * 255
img2 = cv2.imread('Dataset/Gambar Geometri/trapezoid_10.png', cv2.IMREAD_GRAYSCALE)
img2 = (img2 == 255).astype(int) * 255

cv2.imwrite('Logical Operator Image/Hasil/Gambar Biner A.png', img1)
cv2.imwrite('Logical Operator Image/Hasil/Gambar Biner B.png', img2)
...
cv2.imwrite('Logical Operator Image/Hasil/Gambar A.png', img1)
cv2.imwrite('Logical Operator Image/Hasil/Gambar B.png', img2)
...
cv2.imwrite('Logical Operator Image/Hasil/A Gabungan B.png', img3)
...
cv2.imwrite('Logical Operator Image/Hasil/A Irisan B.png', img3)
...
cv2.imwrite('Logical Operator Image/Hasil/A Irisan B Komplemen.png', img3)
...
cv2.imwrite('Logical Operator Image/Hasil/A Komplemen Irisan B.png', img3)
...
cv2.imwrite('Logical Operator Image/Hasil/(A Irisan B) Komplemen Irisan (A Gabungan B).png', img3)
